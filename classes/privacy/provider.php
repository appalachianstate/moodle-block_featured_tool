...
/**
 * Privacy Subsystem implementation for block_featured_tool.
 *
...
namespace block_featured_tool\privacy;
...
class provider implements
        // The block_featured_tool block stores user provided data.
        \core_privacy\local\metadata\provider,

        // This plugin is capable of determining which users have data within it.
        \core_privacy\local\request\core_userlist_provider,

        // The block_featured_tool block provides data directly to core.
        \core_privacy\local\request\plugin\provider {

    /**
     * Returns information about how block_featured_tool stores its data.
     *
    ...
    public static function export_user_data(approved_contextlist $contextlist) {
        ...
        foreach ($instances as $instance) {
            ...
            $html = writer::with_context($context)
                ->rewrite_pluginfile_urls([], 'block_featured_tool', 'content', null, $block->config->text);
